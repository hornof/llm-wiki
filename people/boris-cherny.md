...
- **2026-06-29: canonical-Claude-Code-subagents-default-in-background canonical-next-version-roadmap-anchor** ([[dailybrief-roundup-2026-06-29]]): canonical-Cherny canonical-direct-voice canonical-roadmap-anchor — *"next Claude Code version will run subagents in the background by default. This lets users continue chatting while tasks run independently."* **First wiki-captured canonical-subagents-default-background canonical-Claude-Code-roadmap-anchor**.
- **2026-06-28: STRUCTURALLY MAJOR canonical-5-archetype canonical-future-roles canonical-articulation** ([[bcherny-5-archetype-future-roles-2026-06-28]]): *"As engineering, product, design, DS, etc. melt into a new kind of role"* — canonical-5-archetype canonical-roster: **Prototyper** (idea-churn) + **Builder** (prototype-to-production) + **Sweeper** (cleanup + simplify + unship) + **Grower** (PMF iteration) + **Maintainer** (mature-system stewardship). Canonical-archetypes-not-tied-to-job-function canonical-articulation (canonical-designers + engineers + PMs + DS canonical-spread-across-archetypes at canonical-Anthropic-organizational-tier). Canonical-team-composition-by-product-stage canonical-articulation: pre-PMF = 1+2+3; growing post-PMF = 2+3+4+5; strong PMF = 3+4+5+2. **STRUCTURALLY MAJOR canonical-AI-substitution-tier canonical-3-tier-mapping**: *"#2 can definitely be fulfilled by an AI agent today. #1 is tandem human and AI agent. #3/4/5 best performed by humans. Will be a few years out before AI agents can do 50% or more."* = canonical-first wiki-captured canonical-explicit canonical-archetype-by-archetype canonical-AI-substitution-readiness canonical-articulation at canonical-Anthropic-vendor-tier + canonical-50%-substitution-timeline canonical-few-years-anchor. Extends canonical-Cherny canonical-3-direct-voice canonical-3-week canonical-cadence canonical-anchor-tier canonical-validation (Jun 10 Tokyo + Jun 28 5-archetype + Jun 29 subagents-default). Pairs with [[gregisenberg-ai-native-company-context-layer-2026-06-27|Greg Isenberg canonical-3-pillar canonical-AI-native-company-thesis Jun 27]] = first wiki-captured canonical-2-voice canonical-AI-native-roles-evolution canonical-1-week cluster.
