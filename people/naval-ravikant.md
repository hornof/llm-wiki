...
name: Naval Ravikant
type: person
affiliation: Independent (formerly AngelList)
...
Naval Ravikant is a venture investor, entrepreneur, and philosopher of wealth and technology. He co-founded AngelList in 2010, transforming startup fundraising by democratizing access to early-stage investment. He was an early investor in Twitter, Uber, Notion, and roughly 200 other companies that shaped the last decade of tech.

He is best known outside VC circles for his 2018 Twitter thread "How to Get Rich (Without Getting Lucky)" — a set of compressed aphorisms about wealth creation, leverage, and skill compounding that became one of the most widely shared tech philosophy documents of the decade. He posts and speaks infrequently, which amplifies the signal value of his statements when they do appear.
...
- **Durable moats in the AI era**: distribution, network effects, data flywheels, hardware integration, brand, community, and regulatory depth. Software features are not a moat. Vertical depth (owning one industry's workflow, data, and relationships) beats horizontal breadth.
- **The democratization thesis**: Software is entering a renaissance for individual creators. The ceiling for solo founders is rising dramatically, not falling. Historical outliers (Notch, Instagram 13-person team, WhatsApp 55-person team) become the new baseline expectation.

## Where to Follow

- Twitter/X: @naval
- Podcast: Naval (available on major podcast platforms)
- Prior canonical text: "How to Get Rich (Without Getting Lucky)" — 2018 Twitter thread
