...
Co-founder and CEO of [[box|Box]] (founded 2005, public 2015). One of the most-followed enterprise-SaaS voices on X (2.7M followers as of May 2026 per [[techcrunch-bort-ceo-ai-psychosis-2026-05-27|TechCrunch]]). Active angel investor in AI startups. Generally an AI-positive voice — his most-circulated 2026 framing is *"Headless software is the future"* ([[levie-ceo-ai-psychosis-2026-05-23|cited via]] [link](https://x.com/levie/status/2055357619888595271)) on AI-agent-native software architectures. Worth tracking because (a) he's *inside the AI-bull camp* yet willing to surface within-camp critiques, (b) he runs a public SaaS incumbent and so his framings double as Box-positioning signals, and (c) his posts have demonstrated mainstream-press carry — TechCrunch builds whole articles around his X posts.
...
- X: [@levie](https://x.com/levie) — 2.7M followers (May 2026)
- Box: [box.com](https://www.box.com/) — public SaaS (NYSE: BOX)
