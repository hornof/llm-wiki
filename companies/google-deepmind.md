...
- **Gemini Robotics 2 + Gemini Robotics ER 2** (2026-07-30, [[dailybrief-roundup-2026-07-30]]): a pair of embodied-AI releases — **ER 2** adds **video understanding, task orchestration, and multi-robot collaboration**; **Robotics 2** brings *"whole-body intelligence"* to robots (multimodal embodied reasoning). Concrete frontier-robotics push; the applied counterpart to Jack Clark's *"bitter lesson for robotics"* framing ([[jack-clark]], Import AI 466 — scale beginning to beat hand-crafted priors in robotics). **Marketing-forward: no deployment data or benchmarks in the announcements** — capability claims not yet independently assessable. — *(blog posts; primaries not deeply fetched)*
